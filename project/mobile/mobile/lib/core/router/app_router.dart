    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          // TAB 2: Farm Management (Ponds, Units, Cohorts)
          GoRoute(
            path: '/farm',
            name: 'farm',
          ...
          // TAB 3: Feeding & Precision Schedules
          GoRoute(
            path: '/feeding',
            name: 'feeding',
          ...
          // TAB 4: AquaDoc Grounded Clinical AI Consultant
          GoRoute(
            path: '/aquadoc',
            name: 'aquadoc',
          ...
          // TAB 5: More Hub (Vision, Predict, Research, Devices, Settings)
          GoRoute(
            path: '/more',
            name: 'more',
...
class MainShell extends StatelessWidget {
  ...
  int _calculateSelectedIndex(BuildContext context) {
    ...
    if (location.startsWith('/aquadoc')) return 3;
