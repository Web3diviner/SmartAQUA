  ...
  return (
    <div className="app">
      ...
      <nav className="mobile-bottom-nav" aria-label="Mobile Navigation">
        <NavLink to="/chat" className={({ isActive }) => `mobile-tab-item ${isActive ? 'active' : ''}`}>
          <span className="mobile-tab-icon">💬</span>
          <span>Chat</span>
        </NavLink>
        <NavLink to="/simulator" className={({ isActive }) => `mobile-tab-item ${isActive ? 'active' : ''}`}>
          <span className="mobile-tab-icon">🎮</span>
          <span>Simulator</span>
        </NavLink>
        <NavLink to="/disease" className={({ isActive }) => `mobile-tab-item ${isActive ? 'active' : ''}`}>
          <span className="mobile-tab-icon">🩺</span>
          <span>Triage</span>
        </NavLink>
        {isAuthenticated && user ? (
          <NavLink to="/auth" className={({ isActive }) => `mobile-tab-item ${isActive ? 'active' : ''}`}>
            <span className="mobile-tab-icon">👤</span>
            <span>Profile</span>
          </NavLink>
        ) : (
